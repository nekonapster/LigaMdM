...
<html>
    <head>
        ...
        <title>Login para el administrador</title>
    </head>
    <html lang="en">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="p-5">
                                            ...
                                            <form class="user" method="POST">
                                                <div class="mb-3"><input id="usuario" class="form-control form-control-user" type="text" aria-describedby="Usuario" placeholder="Usuario" name="usuario" required /></div>
